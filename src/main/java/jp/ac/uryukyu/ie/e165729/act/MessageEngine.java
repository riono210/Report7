...
public class MessageEngine {
    ...
    public MessageEngine(){
        ...
        ImageIcon icon = new ImageIcon(cl.getResource("image/font.gif"));
//        ImageIcon icon = new ImageIcon(new File("src/main/java/jp/ac/uryukyu/ie/e165729/image/font.gif").getAbsolutePath());
     ...
     * @param g 描写オブジェクト
     */
    public void drawMassage(int x, int y, String massage, Graphics g){
